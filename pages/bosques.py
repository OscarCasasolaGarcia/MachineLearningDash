...
layout = html.Div([
    ...
    html.Div(id='output-data-upload-bosques'), # output-datatable
...
def parse_contents(contents, filename,date):
    ...
    return html.Div([
        ...
        dbc.Alert('Evidencia de datos correlacionados', color="primary"),
...
@callback(Output('output-data-upload-bosques', 'children'),
...
#         CargasComponentess=CargasComponentes.head(numComponentesACP+1) # Se muestran los primeros 7 componentes

#         #
#         fig2 = px.imshow(CargasComponentes.head(numComponentesACP+1), color_continuous_scale='RdBu_r')
#         fig2.update_layout(title='Cargas de los componentes')
